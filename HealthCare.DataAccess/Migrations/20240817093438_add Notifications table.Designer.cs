...
namespace HealthCare.DataAccess.Migrations
{
    ...
    [Migration("20240817093438_add Notifications table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthCare.DataAccess.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("HealthCare.DataAccess.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthCare.DataAccess.Models.Doctor", b =>
                {
                    b.HasOne("HealthCare.DataAccess.Models.AppUser", "User")
                        .WithOne("Doctor")
                        .HasForeignKey("HealthCare.DataAccess.Models.Doctor", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthCare.DataAccess.Models.Patient", b =>
                {
                    b.HasOne("HealthCare.DataAccess.Models.AppUser", "User")
                        .WithOne("Patient")
                        .HasForeignKey("HealthCare.DataAccess.Models.Patient", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HealthCare.DataAccess.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
